...
<body>
    <main>
        <form action="excluirAgencia.jsp" method="POST">

            <label style="font-weight: bold; font-size: 1.2em;">EXCLUSÃO DE AGÊNCIA</label><br><br>
            <label>Confira os dados da agência que deseja excluir:</label><br><br>
