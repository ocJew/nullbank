...
<body>
    <main>
        <form action="excluirDependente.jsp" method="POST">

            <label style="font-weight: bold; font-size: 1.2em;">EXCLUSÃO DE DEPENDENTE</label><br><br>
            <label>Confira os dados do dependente que deseja excluir:</label><br><br>
            ...
            <input type="text" name="parentesco" value="<%=request.getParameter("parentesco")%>" readonly>

            <label>Idade:</label>
            <input type="number" name="idade" value="<%=request.getParameter("idade")%>" readonly>
